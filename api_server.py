...
app = FastAPI(
    title="AWS N8N Collection API",
    description="Comprehensive automation workflows for AWS services and beyond - Fast API for browsing and searching workflow documentation",
    version="2.0.0",
    contact={
        "name": "beands",
        "url": "https://beands-media.ru",
        "email": "kruykoff@gmail.com",
    },
    license_info={
        "name": "MIT",
